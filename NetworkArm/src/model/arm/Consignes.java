 ...
 * au Arm.
 * 
 * On peut les lire depuis un fichier (read), les sauvegardfer (write) et les modifier.
 * 
 * Signaux envoyés aux Observers:
 *  - sans argument : tout à changer
...
public class Consignes extends Observable {
	...
	/**
	 * Modifier la {@link CommandSequence} stockèe à cet index.
	 */
