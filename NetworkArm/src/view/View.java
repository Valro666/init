...
public class View extends JFrame implements Observer {
	...
	public View(LinkedEnvironment e) {
		...
		freedraw = new ExperienceViewerFree(world.getFree(), this, world.getSize());

		// draw.getArm().addObserver(draw.getCommandViewer());
		freedraw.free.addObserver(freedraw.getCommandViewer());

		// world.getNet().addObserver(draw.getArm2D());
		world.getNet().addObserver(freedraw.getArm2D());

		// world.addObserver(draw.getGraph());
	...
	public ExperienceViewer getDraw() {
		return draw;
	}
